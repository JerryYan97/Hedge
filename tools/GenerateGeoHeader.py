...
def GenerateHeader(headerPathName, geoVertBufInfoArrayList):
    ...
    headerHandle.write("#include <string>\n\n")
    ...
    for geoVertBufInfo in geoVertBufInfoArrayList:
        # Generate static mesh string
        headerHandle.write("    std::string " + geoVertBufInfo[0] + "StrId" + " = \"" + geoVertBufInfo[0] + "\";\n\n");
        ...
        # Generate Idx data
        headerHandle.write("    uint16_t " + geoVertBufInfo[0] + "IdxData" + "[] = {\n")
        idxDataStr = "        "
        newLineCnt = 1
